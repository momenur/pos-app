...
const PaymentTitle = () => {
  ...
  return (
    <section className="flex justify-between bg-[#F8F9FB] px-4 xl:px-6 py-2 xl:py-4  lg:text-xl xl:text-2xl font-semibold border-2 border-[#637381] rounded-md shadow-md">
